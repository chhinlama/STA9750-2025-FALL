...
```
By indexing each borough’s employment to **100 in 2019 Q1**, we can compare proportional changes on a common scale. In this figure, `r nyc_borough_summary$borough[1]` drops to roughly **30-40** at the trough in 2020, while outer boroughs bottom out closer to the **45-60** range. This suggests that Manhattan not only loses the most jobs in absolute terms, but also experiences the largest **percentage decline** in nightlife-relevant employment. The flatter line for smaller boroughs like Staten Island largely reflects their lower starting levels, not the absence of a COVID shock.
